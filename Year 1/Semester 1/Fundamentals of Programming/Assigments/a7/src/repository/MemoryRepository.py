    ...
    def filter_students_according_to_group(self, group):
        ...
        for student in self._all_students_data.values():
            if student.group != group:
                filtered_dictionary[student.id] = student
            else:
                operation_list.append(student)
        self._all_students_data = filtered_dictionary.copy()
        self._stack_of_all_operations_done_to_student_list.append(operation_list)
